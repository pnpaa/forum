<?php
define('DEFAULT_LANGUAGE_PATH', TEMPLATEPATH.'/lang');
...
function et_generate_pot (  ) {
	...
	$file_name	=	'engine';
	$makePOT	=	new MakePOT();
	$makePOT->xgettext('wp-theme', TEMPLATEPATH, DEFAULT_LANGUAGE_PATH.'/'.$file_name.'.po');
 ...
 */
function et_generate_mo ( $file_name ) {
